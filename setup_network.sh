...
echo "Next steps:"
echo "1) Start your Ryu controller in a new terminal:"
...
echo "   ryu-manager --ofp-tcp-listen-port 6653 --observe-links ryu_controller.py"
echo "2) Start your Mininet topology in a new terminal:"
echo "   cd /home/vboxuser/CompProject"
echo "   source /home/vboxuser/comp/bin/activate"
echo "   export PYTHONPATH=\$PYTHONPATH:/home/vboxuser/CompProject"
